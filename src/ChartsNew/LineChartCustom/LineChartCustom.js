...
import styles from './LineChartCustom.module.css';
            ...
            <div className={styles.ChartContainer}>
                <ResponsiveContainer >
                    <LineChart
                        ...
                        <XAxis dataKey="date" label={{ value: "Time in hours", position: "centerBottom", dy: 20 }} />
                        <YAxis type="number" domain={["auto", "auto"]} label={{ value: "Temperature \u2103", position: "insideLeft", angle: -90, dy: 40 }} />
                        <Tooltip />
